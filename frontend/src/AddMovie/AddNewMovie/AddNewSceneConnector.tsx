...
interface AddNewSceneConnectorProps {
  term?: string;
  items: Array<{ id: number; [key: string]: unknown }>;
  lookupScene: (payload: { term: string }) => void;
  clearAddMovie: () => void;
...
class AddNewSceneConnector extends Component<AddNewSceneConnectorProps> {
  //
  // Lifecycle
