...
class AddNewStudioConnector extends Component {
...
AddNewStudioConnector.propTypes = {
...
export default connect(createMapStateToProps, mapDispatchToProps)(AddNewStudioConnector);
